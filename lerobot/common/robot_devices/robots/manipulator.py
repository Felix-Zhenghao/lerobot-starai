...
class ManipulatorRobot:
    ...
    def teleop_step(
        ...
        action = torch.cat(action) # NOTE: action here is the goal pos. It is the abs degree (not delta) of each DoF.
    ...
    def send_action(self, action: torch.Tensor) -> torch.Tensor:
        ...
        for name in self.follower_arms:
            ...
            # NOTE: self.follower_arms[name].motor_names = ['joint1', 'joint2', 'joint3', 'joint4', 'joint5', 'joint6', 'gripper']
